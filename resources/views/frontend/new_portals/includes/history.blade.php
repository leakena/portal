            ...
            <div class="cbp_tmlabel">
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-6">
                        <img class="img-responsive md-margin-bottom-10" src="{{asset('portals/assets/img/main/img3.jpg')}}" alt="">
                    </div>
                    <div class="col-md-4 col-xs-6">
                        <img class="img-responsive md-margin-bottom-10" src="{{asset('portals/assets/img/main/img9.jpg')}}" alt="">
                    </div>
                    <div class="col-md-4 col-xs-6">
                        <img class="img-responsive md-margin-bottom-10" src="{{asset('portals/assets/img/main/img4.jpg')}}" alt="">
                    </div>
                </div>
            </div>
        </li>
