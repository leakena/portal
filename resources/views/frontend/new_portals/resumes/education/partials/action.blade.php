<div class="btn-group pull-right">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="#" class="btn_edit_education" data-toggle="modal" data-target="#edit_form"><i class="fa fa-edit " ></i> Edit Education</a></li>
        <li ><a class="btn_delete_education" href="{{ route('frontend.resume.remove_education',$education->id) }}"><i class="fa fa-trash-o"></i> Delete Education</a></li>
    </ul>
</div>