<div class="btn-group pull-right">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="#" class="btn_edit_skill" data-toggle="modal" data-target="#edit_form"><i
                        class="fa fa-edit "></i> Edit Skill</a></li>
        <li><a class="btn_delete_skill" href="{{ route('frontend.resume.remove_skill',$skill->id) }}"><i
                        class="fa fa-trash-o"></i> Delete Skill</a></li>
    </ul>
</div>