<div class="col-md-3 md-margin-bottom-40">
    ...
    <img class="img-responsive profile-img margin-bottom-20" style="width: 100% !important;" src="{{isset($personal_info)?url('img/backend/resume/profile/'.$personal_info->profile):url('portals/assets/img/team/img32-md.jpg')}}" alt="">

    <ul class="list-group sidebar-nav-v1 margin-bottom-40" id="sidebar-nav-1">
        <li class="list-group-item {{ ActiveManager::isActiveRoute('frontend.portal.index') }}">
            <a href="{{route('frontend.portal.index')}}"><i class="fa fa-bar-chart-o"></i> {{trans('portal.left_sidebar.menu.overal')}}</a>
        </li>
        <li class="list-group-item {{ ActiveManager::isActiveRoute('frontend.portal.profile') }}">
            <a href="{{route('frontend.portal.profile')}}"><i class="fa fa-user"></i> {{trans('portal.left_sidebar.menu.profile')}}</a>
        </li>
        <li class="list-group-item {{ ActiveManager::isActiveRoute('frontend.portal.classmate') }} ">
            <a href="{{route('frontend.portal.classmate')}}"><i class="fa fa-group"></i> {{trans('portal.left_sidebar.menu.class_mate')}}</a>
        </li>
        <li class="list-group-item {{ ActiveManager::isActiveRoute('frontend.portal.involve_project') }}">
            <a href="{{route('frontend.portal.involve_project')}}"><i class="fa fa-cubes"></i> {{trans('portal.left_sidebar.menu.project')}}</a>
        </li>
       {{-- <li class="list-group-item">
        ...
        <li class="list-group-item {{ ActiveManager::isActiveRoute('frontend.portal.history') }}">
            <a href="{{route('frontend.portal.history')}}"><i class="fa fa-history"></i> {{trans('portal.left_sidebar.menu.history')}}</a>
        </li>
        <li class="list-group-item {{ ActiveManager::isActiveRoute('frontend.portal.setting') }}">
            <a href="{{route('frontend.portal.setting')}}"><i class="fa fa-cog"></i> {{trans('portal.left_sidebar.menu.setting')}}</a>
        </li>
        <li class="list-group-item list-toggle {{ ActiveManager::areActiveRoutes($resumeActiveRoute) }}">
            ...
            <a class="{{$check['class']}}" href="#collapse-forms" data-toggle="collapse" aria-expanded="{{ $check['status'] }}"> <i class="icon-education-164" style="font-size: 12pt"></i>  Resume </a>
            <ul id="collapse-forms" class="collapse {{ $check['in'] }}" aria-expanded="{{ $check['status'] }}" {{$check['style']}}>
                ...
                <li>
                    {{--<span class="badge badge-u">New</span>--}}
                    <a href="shortcode_form_layouts.html"><i class="fa fa-flag"></i> Language </a>
                </li>
                <li>
                    {{--<span class="badge badge-u">New</span>--}}
