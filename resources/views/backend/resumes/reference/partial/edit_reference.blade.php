        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br/>
                        <form action="/resume/references/save-reference" method="POST" id="demo-form2"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="position" name="position"
                                           class="form-control col-md-7 col-xs-12" value="{{ $reference->position }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="description" name="phone"
                                           class="form-control col-md-7 col-xs-12" value="{{ $reference->phone }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="email" id="description" name="email"
                                           class="form-control col-md-7 col-xs-12" value="{{ $reference->email }}">
                                </div>
                            </div>
